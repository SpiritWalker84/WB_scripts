...
- ✅ Разбиение прайсов по брендам (BOSCH, TRIALLI, MANN, SANGSIN, DENSO)
- ✅ Обновление остатков на всех складах Wildberries
- ✅ Обновление цен с автоматическим повышением на 60%
...
По умолчанию обрабатываются бренды: BOSCH, TRIALLI, MANN, SANGSIN, DENSO
...
**Примечание:** Для бренда SANGSIN обрабатываются только артикулы, начинающиеся на "SP" и заканчивающиеся на цифру.

## Настройка коэффициента цены

По умолчанию цена повышается на 60% (коэффициент 1.6)
